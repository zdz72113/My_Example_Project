...
namespace ObjectDetection_Onnx
{
    internal class Program
    {
        ...
        {
            var modelFilePath = Path.Combine(_assetsPath, "Model", "TinyYolo2_model.onnx");
            var imagesFolder = Path.Combine(_assetsPath, "images");
            var outputFolder = Path.Combine(_assetsPath, "images", "output");
